...
namespace SlidingTabLayoutTutorial
{
    public class SlidingTabStrip : LinearLayout
    {
        ...
        private int[] INDICATOR_COLORS = { 0xCC0000, 0x0000FC };// цвета на переходе(красный и синий)
        private int[] DIVIDER_COLORS = { 0xC5C5C5 }; //цвет переходной панели(серебро)
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            SlidingTabScrollView.ITabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
